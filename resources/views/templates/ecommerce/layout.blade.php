...
<head>
    ...
    <meta name="author" content="walternguyen">
    ...
    <!-- Icons -->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/fontawesome.css')}}">

    <!--Slick slider css-->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/slick-theme.css')}}">

    <!-- Animate icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/animate.css')}}">

    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/themify-icons.css')}}">

    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/bootstrap.css')}}">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset($templateFile.'/css/color1.css')}}" media="screen" id="color">
...
<body data-gr-c-s-loaded="true" style="overflow: auto;" cz-shortcut-listen="true" class="">
    ...
    <section class="p-0">
        <div class="slide-1 home-slider slick-initialized slick-slider"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
            <div class="slick-list draggable">
                <div class="slick-track" style="opacity: 1; width: 9515px; transform: translate3d(-1903px, 0px, 0px);">
                    <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 1903px;">
                        <div>
                    ...
                    <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 1903px;">
                        <div>
                            <div style="width: 100%; display: inline-block;">
                    ...
                    <div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" style="width: 1903px;">
                        <div>
                            <div style="width: 100%; display: inline-block;">
                                <div class="home text-center bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/home-banner/2.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                    <img src="../assets/images/home-banner/2.jpg" alt="" class="bg-img blur-up lazyload" style="display: none;">
                    ...
                    <div class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabindex="-1" style="width: 1903px;">
                        <div>
                            <div style="width: 100%; display: inline-block;">
                    ...
                    <div class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 1903px;">
                        <div>
                            <div style="width: 100%; display: inline-block;">
        ...
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/sub-banner1.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                <img src="../assets/images/sub-banner1.jpg" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4>save 30%</h4>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part bg-size blur-up lazyloaded" style="background-image: url(&quot;../assets/images/sub-banner2.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                                <img src="../assets/images/sub-banner2.jpg" class="img-fluid blur-up lazyload bg-img" alt="" style="display: none;">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4>save 60%</h4>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram slick-initialized slick-slider"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="display: inline-block;">Previous</button>
                        <div class="slick-list draggable">
                            <div class="slick-track" style="opacity: 1; width: 6800px; transform: translate3d(-1904px, 0px, 0px);">
                                <div class="slick-slide slick-cloned" data-slick-index="-7" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-6" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-5" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/9.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                ...
                                <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/2.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/4.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/4.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/9.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="4" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/6.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/6.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="5" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/7.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/7.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-active" data-slick-index="6" aria-hidden="false" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="0">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/8.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/8.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide" data-slick-index="7" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/9.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide" data-slick-index="8" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/2.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="9" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/2.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="10" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/3.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/3.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="11" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/4.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/4.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="12" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/9.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="13" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/6.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/6.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="14" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/7.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/7.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="15" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/8.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/8.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="16" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/9.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/9.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="17" aria-hidden="true" tabindex="-1" style="width: 272px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <a href="#" tabindex="-1">
                                                <div class="instagram-box bg-size" style="background-image: url(&quot;../assets/images/slider/2.jpg&quot;); background-size: cover; background-position: center center; display: block;"> <img src="../assets/images/slider/2.jpg" class="bg-img" alt="Avatar" style="width: 100%; display: none;">
                            ...
                            <div class="slick-track" style="opacity: 1; width: 5038px; transform: translate3d(-1374px, 0px, 0px);">
                                    ...
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/3.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="-5" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/4.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/5.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/6.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/7.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/8.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/1.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/2.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/3.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/4.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-active" data-slick-index="4" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/5.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-active" data-slick-index="5" aria-hidden="false" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="0"><img src="../assets/images/logos/6.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="slick-slide slick-cloned" data-slick-index="8" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/1.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="slick-slide slick-cloned" data-slick-index="9" aria-hidden="true" tabindex="-1" style="width: 229px;">
                                    <div>
                                        <div style="width: 100%; display: inline-block;">
                                            <div class="logo-block">
                                                <a href="#" tabindex="-1"><img src="../assets/images/logos/2.png" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade bd-example-modal-lg theme-modal exit-modal" id="exit_popup" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body modal1">
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="media">
                                        <img src="../assets/images/stop.png" class="stop img-fluid blur-up mr-3 lazyloaded" alt="">
    ...
    <!-- latest jquery-->
    <script src="{{ asset($templateFile.'/js/jquery-3.3.1.min.js')}}"></script>

    <!-- fly cart ui jquery-->
    <script src="{{ asset($templateFile.'/js/jquery-ui.min.js')}}"></script>

    <!-- exitintent jquery-->
    <script src="{{ asset($templateFile.'/js/jquery.exitintent.js')}}"></script>
    <script src="{{ asset($templateFile.'/js/exit.js')}}"></script>
    ...
    <!-- menu js-->
    <script src="{{ asset($templateFile.'/js/menu.js')}}"></script>

    <!-- lazyload js-->
    <script src="{{ asset($templateFile.'/js/lazysizes.min.js')}}"></script>

    <!-- Bootstrap js-->
    <script src="{{ asset($templateFile.'/js/bootstrap.js')}}"></script>

    <!-- Bootstrap Notification js-->
    <script src="{{ asset($templateFile.'/js/bootstrap-notify.min.js')}}"></script>

    <!-- Fly cart js-->
    <script src="{{ asset($templateFile.'/js/fly-cart.js')}}"></script>

    <!-- Theme js-->
    <script src="{{ asset($templateFile.'/js/script.js')}}"></script>
